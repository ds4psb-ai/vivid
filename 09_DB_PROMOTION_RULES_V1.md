...
- **labels에 ops_only 포함** 시 승격 금지 (Mega-Notebook 결과 차단)
...
### 8.2 validated 승격 기준
**필수**: source_id + evidence_ref 존재, pattern_name이 Taxonomy 준수, 최소 2개 소스 반복 확인
**권장**: confidence ≥ 0.6, 다른 거장에서도 재현

### 8.3 promoted 승격 기준
**필수**: Pattern Trace ≥ 5, 2개 계보 반복, Pattern Lift 평균 ≥ 0.10
**권장**: Evidence Coverage ≥ 0.6, 사용자 피드백 개선 관찰
