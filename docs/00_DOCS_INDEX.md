...
| [RAG_ARCHITECTURE.md](./RAG_ARCHITECTURE.md) | Multi-RAG Router + Hybrid Search (P0-P7 완료) | ✅ Active |
...
## 2. Developer Guides (개발자 가이드)

| 문서 | 설명 | 상태 |
|------|------|------|
| [DIMENSION_APP_DEVELOPER_GUIDE.md](./DIMENSION_APP_DEVELOPER_GUIDE.md) | **앱 개발 가이드 (React 19, i18n)** | ✅ Active |
| [DEVELOPER_STATUS_GUIDE.md](./DEVELOPER_STATUS_GUIDE.md) | 개발 현황 및 Known Issues | ✅ Active |
| [TESTING_GUIDE.md](./TESTING_GUIDE.md) | 테스트 작성 가이드 | ✅ Active |
...
| 문서 | 앱 |
|------|-----|
| [01_ABYSS_MIRROR_RESEARCH.md](./research/01_ABYSS_MIRROR_RESEARCH.md) | Abyss Mirror |
| [02_REFERENCE_DECODER_RESEARCH.md](./research/02_REFERENCE_DECODER_RESEARCH.md) | Reference Decoder |
| [03_SCENARIO_GENERATOR_RESEARCH.md](./research/03_SCENARIO_GENERATOR_RESEARCH.md) | Scenario Generator |
| [04_SOUND_CRAFTER_RESEARCH.md](./research/04_SOUND_CRAFTER_RESEARCH.md) | Sound Crafter |
| [05_STORYBOARD_SKETCHER_RESEARCH.md](./research/05_STORYBOARD_SKETCHER_RESEARCH.md) | Storyboard Sketcher |
| [06_PROMPT_ALCHEMY_RESEARCH.md](./research/06_PROMPT_ALCHEMY_RESEARCH.md) | Prompt Alchemy |
| [07_VISUAL_REALIZER_RESEARCH.md](./research/07_VISUAL_REALIZER_RESEARCH.md) | Visual Realizer |
| [08_VIDEO_MAKER_RESEARCH.md](./research/08_VIDEO_MAKER_RESEARCH.md) | Video Maker |
| [09_QUALITY_DIRECTOR_RESEARCH.md](./research/09_QUALITY_DIRECTOR_RESEARCH.md) | Quality Director |
| [10_AESTHETIC_DIRECTOR_RESEARCH.md](./research/10_AESTHETIC_DIRECTOR_RESEARCH.md) | Aesthetic Director |
...
- **AI**: Google Gemini API + VEO 3.1 + Suno + Kling 2.6
...
| 문서 | 설명 |
|------|------|
| [abyss-mirror.md](./specs/abyss-mirror.md) | 심연의 거울 SPEC |
...
완료된 플래닝 문서:
- `PHASE2_APP_MAPPING_PLAN.md`
- `APP_RENAMING_AND_DEVELOPMENT_PLAN.md`
- `F2_API_CONTRACT_PLAN.md`
- `RAG_NEXT_PHASE_PLAN_2026-01-11.md`
- `RAG_REFACTOR_FINAL_PLAN_2026-01-11.md`
- `UQSL_IMPLEMENTATION_COMPLETE_REPORT.md`

### `/archive/specs`

완료된 SPEC 문서:
- `P2_BACKEND_ABC_SPEC.md`
- `P2_IMPLEMENTATION_PLAN_DETAILED.md`
- `P3_ENSEMBLE_RETRIEVER_SPEC.md`
