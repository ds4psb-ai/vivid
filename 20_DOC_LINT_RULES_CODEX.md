...
- **Sheets/DB 계약**: `06_SHEETS_SCHEMA_V1.md`, `09_DB_PROMOTION_RULES_V1.md`
...
- 새 결정(원칙/흐름/역할 변화)은 `15_CREBIT_ARCHITECTURE_EVOLUTION_CODEX.md`에 먼저 반영.
- 흐름/역할 변경은 `08_PIPELINES_AND_USER_FLOWS.md`에 먼저 반영.
- 파이프라인/스키마 변경은 관련 계약 문서(06/07/09/25)에 우선 반영.
- 문서 구조 변경 시 `16_DOCUMENTATION_STRUCTURE_CODEX.md`에 링크 갱신.
...
**허용 예시**
- "상세 흐름은 `08_PIPELINES_AND_USER_FLOWS.md` 참조."
- "영상 구조화는 `19_VIDEO_UNDERSTANDING_PIPELINE_CODEX.md` 참조."
