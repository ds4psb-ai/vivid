  ...
  return (
    <div
      className={`rounded-2xl border px-4 py-3 ${
        isError ? "border-rose-500/40 bg-rose-500/10" : "border-white/10 bg-white/5"
      }`}
    >
      ...
      <div className="border-t border-white/10 px-5 py-4">
        <div className="rounded-2xl border border-white/10 bg-slate-950/60 p-3">
          ...
          <div className="mt-3 flex items-center justify-between">
            <div className="text-xs text-slate-500">{t("studioChatInputHint")}</div>
            {isStreaming ? (
              <button
                type="button"
                onClick={onStop}
                className="inline-flex items-center gap-2 rounded-full border border-rose-500/40 bg-rose-500/10 px-4 py-2 text-xs font-semibold text-rose-100 transition hover:border-rose-500/70 hover:bg-rose-500/20"
              >
              ...
              <button
                ...
                onClick={handleSend}
                disabled={!canSend}
                className={`inline-flex items-center gap-2 rounded-full border border-sky-500/40 bg-sky-500/10 px-4 py-2 text-xs font-semibold text-sky-100 transition hover:border-sky-500/70 hover:bg-sky-500/20 ${
