...
export default function TeachingPanelLayout({
    ...
    return (
        <div className="flex h-full w-full overflow-hidden relative">
            ...
            <div className="w-[var(--layout-sidebar-width)] flex-shrink-0 flex flex-col border-r border-[var(--border-subtle)] bg-[var(--surface-1)]/80 backdrop-blur-xl relative z-20">
