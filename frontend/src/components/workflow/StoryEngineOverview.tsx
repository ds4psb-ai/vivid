...
function ProductionBridgeBanner({
  ...
  return (
    <div
      className={cn(
        "p-4 rounded-xl bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20",
        className
      )}
    >
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-gradient-to-r from-emerald-500 to-cyan-500 text-white hover:opacity-90 transition-opacity"
        >
          Production으로 이동
          <ArrowRight className="w-4 h-4" />
        </button>
    ...
    >
      ...
      {hasDNALabData && onStartFromFirst && (
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:opacity-90 transition-opacity"
        >
          스토리 설계 시작
          <ArrowRight className="w-4 h-4" />
        </button>
