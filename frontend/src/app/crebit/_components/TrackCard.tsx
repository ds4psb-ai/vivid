...
export function TrackCard({ type, title, badge, schedule, desc, color }: TrackCardProps) {
    return (
        <div className="card-premium group relative p-10 hover:border-white/20 transition-all duration-300 hover:-translate-y-2 overflow-hidden">
            ...
            <div
                className="absolute -right-20 -top-20 w-96 h-96 rounded-full blur-[100px] opacity-0 group-hover:opacity-20 transition-opacity duration-500 pointer-events-none"
