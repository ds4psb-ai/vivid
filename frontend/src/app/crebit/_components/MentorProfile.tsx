...
export function MentorProfile({ img, name, role, tags }: MentorProfileProps) {
    return (
        <div className="card-premium p-6 hover:border-white/20 transition-all hover:bg-white/5 flex items-center gap-6 group">
            ...
            <div>
                <h4 className="text-lg font-bold text-white mb-1 group-hover:text-emerald-400 transition-colors">{name}</h4>
