      ...
      <div className="min-h-screen bg-[#050505] flex items-center justify-center p-8 font-sans">
        ...
        <div className="relative max-w-lg w-full">
          ...
          <div className="relative bg-[#0f0f11] border border-white/10 rounded-[2.5rem] p-10 shadow-2xl text-center">
            ...
            {/* Access Request Button - show if logged in and no pending request */}
            {isLoggedIn && requestStatus === "idle" && (
              <button
                onClick={handleAccessRequest}
                className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-bold rounded-2xl hover:from-purple-600 hover:to-indigo-600 transition-all shadow-lg shadow-purple-500/20 group mb-4"
              >
