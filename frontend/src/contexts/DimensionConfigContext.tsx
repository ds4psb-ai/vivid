...
const FALLBACK_TOOLS: DimensionToolConfig[] = [
    ...
    // SOUND / STORY (AppRegistry aligned, legacy SC/SA handled elsewhere)
    { toolId: "sound_craft", dimension: "SOUND", displayName: "사운드 크래프터", displayNameEn: "Sound Crafter", description: "AI 사운드 디자인 생성", icon: "music", color: "purple", stage: "production", capsuleKey: "dimension.sound.craft", endpoint: "/api/dimension/sound/craft", creditCost: 8 },
    { toolId: "story_architect", dimension: "STORY", displayName: "스토리 아키텍트", displayNameEn: "Story Architect", description: "시나리오 구조 설계", icon: "book-open", color: "emerald", stage: "planning", capsuleKey: "dimension.story.architect", endpoint: "/api/dimension/story/architect", creditCost: 10 },
