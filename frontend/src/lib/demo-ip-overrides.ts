...
export const DEMO_IP_OVERRIDES: Record<string, DemoIPOverride> = {
  ...
  "umbrella-encounter": {
    ...
    aspectRatio: "9:16",
    localVideoPath: "/Users/ted/vivid/video/실수로 모르는 여자애 우산 속에 들어갔을 때 #drama #kdrama #웹드라마 #드라마.mp4",
    previewVideoUrl: "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
    detailVideoUrl: "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
    thumbnailUrl: "https://picsum.photos/seed/umbrella/400/600",
    isNew: true,
    viewCount: "1.2M",
    workflows: [
      {
  ...
  "cooking-anime-mv": {
    ...
    aspectRatio: "16:9",
    localVideoPath: '/Users/ted/vivid/video/흑백요리사2 애니 오프닝 - "MOVING ON" (AI).mp4',
    previewVideoUrl: "https://storage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4",
    detailVideoUrl: "https://storage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4",
    thumbnailUrl: "https://picsum.photos/seed/anime-mv/400/225",
    isHot: true,
    viewCount: "3.5M",
    workflows: [
      {
