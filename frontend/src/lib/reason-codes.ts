...
const REASON_CODE_KEYS: Record<string, keyof typeof translations.ko> = {
  ...
  "auteur:nolan": "reasonCodeAuteurNolan",
  "auteur:kubrick": "reasonCodeAuteurKubrick",
  "auteur:tarantino": "reasonCodeAuteurTarantino",
  "auteur:ghibli": "reasonCodeAuteurGhibli",
  "auteur:villeneuve": "reasonCodeAuteurVilleneuve",
  "auteur:fincher": "reasonCodeAuteurFincher",
  "auteur:wes_anderson": "reasonCodeAuteurWesAnderson",
  "auteur:spielberg": "reasonCodeAuteurSpielberg",
  "auteur:scorsese": "reasonCodeAuteurScorsese",
